...
#sp.run(['bash', '-c', 'python train.py  --Nt 64 --Nr 4 --dk 2 --K 8 --SNR 0 --SNR_channel 100 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 2'])
#sp.run(['bash', '-c', 'python prune_naive.py  --Nt 64 --Nr 4 --dk 2 --K 8 --SNR 0 --SNR_channel 100 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 2'])

#sp.run(['bash', '-c', 'python train.py  --Nt 64 --Nr 4 --dk 2 --K 10 --SNR 0 --SNR_channel 100 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 2'])
#sp.run(['bash', '-c', 'python prune_naive.py  --Nt 64 --Nr 4 --dk 2 --K 10 --SNR 0 --SNR_channel 100 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 2'])
#
#sp.run(['bash', '-c', 'python train.py  --Nt 64 --Nr 4 --dk 2 --K 12 --SNR 0 --SNR_channel 100 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 2'])
#sp.run(['bash', '-c', 'python prune_naive.py  --Nt 64 --Nr 4 --dk 2 --K 12 --SNR 0 --SNR_channel 100 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 2'])
#
#sp.run(['bash', '-c', 'python train.py  --Nt 64 --Nr 4 --dk 2 --K 14 --SNR 0 --SNR_channel 100 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 2'])
#sp.run(['bash', '-c', 'python prune_naive.py  --Nt 64 --Nr 4 --dk 2 --K 14 --SNR 0 --SNR_channel 100 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 2'])
#
#sp.run(['bash', '-c', 'python train.py  --Nt 64 --Nr 4 --dk 2 --K 16 --SNR 0 --SNR_channel 100 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 2'])
#sp.run(['bash', '-c', 'python prune_naive.py  --Nt 64 --Nr 4 --dk 2 --K 16 --SNR 0 --SNR_channel 100 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 2'])
...
#
'''generate dataset'''
#sp.run(['bash', '-c', 'python generate_dataset.py --Nt 64 --Nr 4 --K 10 --dk 2 --B 1 --SNR 0 --SNR_channel 100 --gpu 0 --mode debug --batch_size 200 --epoch 1000 --factor 1'])
sp.run(['bash', '-c', 'python learn_from_bar_merge_rb.py --Nt 64 --Nr 4 --K 10 --dk 2 --B 4 --SNR 0 --SNR_channel 100 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 1'])

#sp.run(['bash', '-c', 'python learn_tf.py --Nt 64 --Nr 4 --K 10 --dk 2 --B 4 --SNR 0 --SNR_channel 100 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 1'])

#sp.run(['bash', '-c', 'python generate_dataset.py --Nt 64 --Nr 4 --K 10 --dk 3 --B 4 --SNR 0 --SNR_channel 100 --gpu 0 --mode debug --batch_size 200 --epoch 1000 --factor 1'])
#sp.run(['bash', '-c', 'python generate_dataset.py --Nt 64 --Nr 4 --K 10 --dk 4 --B 4 --SNR 0 --SNR_channel 100 --gpu 0 --mode debug --batch_size 200 --epoch 1000 --factor 1'])
