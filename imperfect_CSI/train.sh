...
#python3 -u imperfect_CSI/train_main.py              --Nt 64 --Nr 4 --K 12 --dk 2 --B 1 --SNR 0 --SNR_channel -5 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 1
#python3 -u imperfect_CSI/train_main.py              --Nt 64 --Nr 4 --K 12 --dk 2 --B 1 --SNR 0 --SNR_channel 0 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 1
#python3 -u imperfect_CSI/train_main.py              --Nt 64 --Nr 4 --K 12 --dk 2 --B 1 --SNR 0 --SNR_channel 5 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 1
python3 -u imperfect_CSI/train_main.py              --Nt 64 --Nr 4 --K 12 --dk 2 --B 1 --SNR 0 --SNR_channel 10 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 1
python3 -u imperfect_CSI/train_main.py              --Nt 64 --Nr 4 --K 12 --dk 2 --B 1 --SNR 0 --SNR_channel 15 --gpu 0 --mode gpu --batch_size 200 --epoch 1000 --factor 1
